...
def get_neighbor(valid_points, scene_points, lengths_1, lengths_2):
    _, neighbor_in_scene_pcld, _ = ball_query(valid_points, scene_points, lengths_1, lengths_2, K=20, radius=DISTANCE_THRESHOLD, return_nn=False) # mask反投影点在GT点云中可见 <-> 反投影点与GT点云中最近点距离不大于DISTANCE_THRESHOLD
