...
# python -m visualize.vis_scene --config scannet --seq_name scene0050_00_ours
# cd data/vis/scene_0050_00_ours
...
def main(args):
    ...
    if len(scene_colors) == 0:  # 我们的mono点云数据没有颜色，赋黑色
        scene_colors = np.random.randint(0, 256, scene_points.shape)
