...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/home/zhangwenyuan/data/DTU_pixelnerf/dtu_scan118/', type=str, help='input data path')
    ...
    rgbs = []
    # scannet
    # K = np.loadtxt(os.path.join(opt.data_dir, 'intrinsic', 'intrinsic_color.txt'))
    # img_rescale = 0.5
    # raw_intrinsic = [K[0][0]*img_rescale, K[1][1]*img_rescale, K[0][2]*img_rescale, K[1][2]*img_rescale]

    camera_dict = np.load(os.path.join(opt.data_dir, 'cameras_sphere.npz'))
